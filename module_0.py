...
def game_core_v3(number):
    """ Берем изначальный интервал и делим его пополам. После этого берем шаг равный половине от числа которого
        мы взяли как первый predict. В функции перемещение по числу по в поисках заданного числа производ"""
